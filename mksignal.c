 ...
 * [NOTE]
 * ====
 * This file _intentionally_ does not depend on es.h.
 * The mksignal program is merely used to generate sigmsgs.c and is pretty much standalone.
 * ====
 *
 */
...
int
es_sigcmp(const void *a, const void *b) {
	const Sigmsgs *sa = a;
	const Sigmsgs *sb = b;
