...
es_noreturn extern void panic(const char *fmt VARARGS);
...
es_noreturn extern void throw(List *exc);
es_noreturn extern void fail(const char *from, const char *name VARARGS);
